...
public class Consumer extends Node {
    ...
    public void askForChannels() throws IOException, ClassNotFoundException {
    ...
    public void askForTags() throws IOException, ClassNotFoundException {
        for (ConnectionMetadata metadata : super.getConnectionMetadataForEachBroker()) {
    ...
    public void askForVideosOfChannel(String channel) throws IOException, ClassNotFoundException {
...
//        System.out.println("Broker number: "  +broker_no);
//        System.out.println("Broker metadata:"  + metadata.toString());
    ...
    public void askForVideosOfTag(String tag) throws IOException, ClassNotFoundException {
...
//        System.out.println("Broker metadata:"  + metadata.toString());
    ...
    public void askForVideoOfChannel(String channel, String video) throws IOException, ClassNotFoundException { // pull
        BigInteger hash = HashCalculator.hash(channel);
        int broker_no = HashCalculator.decideWhereToSend(hash) - 1;
...
//        System.out.println("Broker metadata:"  + metadata.toString());
        ...
        if (res.getData().equals("FOUND")) {
            ...
            String path = resourceDirectory + "/downloads/" + video;
            ...
            System.out.println("Video saved to : " + path);
        } else {
            System.out.println("video not found ...");
        }
    }

    public void askForVideoOfTag(String tag, String video) throws IOException, ClassNotFoundException { // pull
        BigInteger hash = HashCalculator.hash(tag);
        int broker_no = HashCalculator.decideWhereToSend(hash) - 1;
