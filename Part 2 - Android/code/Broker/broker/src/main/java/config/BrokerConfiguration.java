...
public class BrokerConfiguration {
    ...
    // Broker specific:
    public static int WHO_AM_I = 1;
    public static String MY_IP = BROKER_IP_1;
    public static int MY_PORT = BROKER_PORT_1;

    // *******************************************************************
    public static final boolean CONNECT_ONLY_TO_ONE_BROKER = true;
